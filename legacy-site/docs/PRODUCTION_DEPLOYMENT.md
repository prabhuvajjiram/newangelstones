# Retired Production Deployment Guide - Promotions System

> Archived for historical reference only. Do not follow these instructions for
> the current Next.js public website. Historical credentials have been
> redacted; current secrets must remain in the approved server secret store.
...
**Default Admin User:**
- Username: `Angel`
- Password: `[REDACTED - historical credential]`
...
- [ ] Login with the approved credentials from the server secret store.
