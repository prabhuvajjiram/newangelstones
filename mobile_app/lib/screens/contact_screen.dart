...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Future<void> _loadConfiguration() async {
    try {
      ...
      if (mounted) {
        setState(() {
          _paymentUrl = results[0].isNotEmpty ? results[0] : null;
  ...
  Widget _buildContactCard({
    ...
    return Semantics(
      button: onTap != null,
      enabled: onTap != null,
      label: '$title. $subtitle${onTap == null ? '. Unavailable' : ''}',
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildContactCard(
                        ...
                        onTap: () => _openMap(
                            'P.O. Box 370, Elberton, GA 30635', context),
                      ),
                    ],
                  ),
                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  inputFormatters: [
                                    FilteringTextInputFormatter.allow(RegExp(
                                        r'[0-9\s\-()]')), // Allow digits, spaces, hyphens, and parentheses
  ...
  Widget _buildLocationCard(
      String title, String address, String mapUrl, int delayMilliseconds) {
